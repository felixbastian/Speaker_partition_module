...
csv_folder = Path("C:/Users/felix/OneDrive/Dokumente/Python Projects/audio_percentage/audiosamples/output_documentation.csv")
...
np.savez_compressed('./uis-rnn-master/d-vector_file', utterance_array=utterance_array1, cluster_ID_array=cluster_ID_array)
